      ...
      <nav className="navbar">
        <div className="navbar-wrapper">
          <div className="navbar-header-logo">
            ...
            <a href= "/"> <img src={seat_transparent} alt="" className="seat-transparent" width="115" height="600"/></a> 
          </div>
          {/* <span style={{ fontSize:'15px'}}>{sessionStorage.getItem("email")}</span> */}
          <div className="navbar-content">
          <style>@import url('https://fonts.googleapis.com/css2?family=Lato:wght@300;400&family=Raleway:wght@600&display=swap');</style>
